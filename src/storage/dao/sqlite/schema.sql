...
CREATE INDEX IF NOT EXISTS idx_sentiment_recording ON sentiment_analysis(recording_id);
CREATE INDEX IF NOT EXISTS idx_sentiment_speaker ON sentiment_analysis(speaker_id);
